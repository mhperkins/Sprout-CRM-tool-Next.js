...
export const ContactSchema = z.object({
  ...
  relationship_types:   z.preprocess(
    v => (v == null ? [] : Array.isArray(v) ? v : [v]),
    z.array(z.enum(["music", "art", "event_host", "partner", "community_builder", "attendee", "showcase", "sprout_society", "other"])).default([])
  ),
  ...
  segment:              z.enum(["community", "member", "donor", "prospect"]).nullish().transform(v => v ?? "community"),
