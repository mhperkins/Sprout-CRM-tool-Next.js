// lib/newsletter.js â€” Newsletter template engine (shared)
...
// MCP tool can import from here â€” one source of truth for the templates.
//
// Flow: start from a raw template â†’ fill CRM-derived blocks (recaps, upcoming
// events, profile footer, month) â†’ expose the REMAINING [BRACKETS] as editable
// fields â†’ substitute the user's field values. Empty fields keep their bracket so
...
export const TEMPLATES = [
  {
    ...
    blurb: "Featured event photo â†’ coworking â†’ membership â†’ community spotlight â†’ all events. Compact, mobile-first (~7in tall). Custom section fields with add-more for events.",
  },
  {
    id: "quick-hit",
    name: "Quick Hit",
    blurb: "Short single-focus send between roundups: heading, body, announcements, and an upcoming event with an adjustable photo. Same section editor as the roundup.",
  },
];

/* â”€â”€â”€ Compact roundup: structured section model â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export const COMPACT_SECTIONS = [
  ...
  { key: "mastheadLabel",  label: "Masthead â€” label",                 kind: "header", ph: "Sprout Monthly" },
  { key: "headline",       label: "Headline",                         kind: "single", rows: 2, polish: true },
  { key: "intro",          label: "Intro / thank-you",                kind: "single", rows: 3, polish: true },
  { key: "featuredEyebrow", label: "Featured â€” eyebrow",              kind: "header", ph: "Featured" },
  { key: "featuredTitle",  label: "Featured event â€” title",           kind: "single", rows: 1 },
  { key: "featuredRecap",  label: "Featured event â€” recap",           kind: "single", rows: 3, polish: true },
  { key: "featuredAnnounce", label: "Featured event â€” announcement (optional)", kind: "single", rows: 2, polish: true },
  { key: "featuredPhoto",  label: "Featured event â€” photo",           kind: "image", crop: true, ratio: 544 / 200 },
  { key: "coworkingEyebrow", label: "Announcement â€” eyebrow",          kind: "header", ph: "Announcement" },
  { key: "coworkingTitle", label: "Announcement â€” title",             kind: "header", ph: "e.g. Sprout Co-Working: Tuesdays and Thursdays" },
  { key: "coworking",      label: "Announcement â€” body",              kind: "single", rows: 2, polish: true },
  { key: "coworkingChip",  label: "Announcement â€” highlight chip label (optional)", kind: "header", ph: "Sprout-by-Day" },
  { key: "coworkingThurs", label: "Announcement â€” highlight line (optional)", kind: "single", rows: 1, polish: true },
  { key: "membership",     label: "Membership ask",                   kind: "single", rows: 2, polish: true },
  { key: "membershipBtn",  label: "Membership â€” button label",        kind: "header", ph: "Become a member" },
  { key: "membershipLink", label: "Membership â€” button link",         kind: "single", ph: "https://givebutter.com/sproutmembership" },
  { key: "marketing",      label: "Marketing â€” message",              kind: "single", rows: 2, polish: true },
  { key: "marketingLink",  label: "Marketing â€” button: URL, or [Button text](URL)", kind: "single", rows: 1 },
  { key: "scholarship",    label: "Scholarship â€” message",            kind: "single", rows: 2, polish: true },
  { key: "scholarshipBtn", label: "Scholarship â€” button label",       kind: "header", ph: "Learn more" },
  { key: "scholarshipLink", label: "Scholarship â€” button link (URL)", kind: "single", rows: 1 },
  { key: "spotlightEyebrow", label: "Community spotlight â€” eyebrow",   kind: "header", ph: "Community Sprout Shout" },
  { key: "spotlightName",  label: "Community spotlight â€” name",        kind: "single", rows: 1 },
  { key: "spotlightBlurb", label: "Community spotlight â€” blurb",       kind: "single", rows: 3, polish: true },
  { key: "spotlightImage", label: "Community spotlight â€” photo",       kind: "image", crop: true, ratio: 495 / 200 },
  { key: "spotlightIG",    label: "Community spotlight â€” Instagram: URL, or [Button text](URL)", kind: "single", rows: 1 },
  { key: "spotlightWeb",   label: "Community spotlight â€” website/streaming: URL, or [Button text](URL)", kind: "single", rows: 1 },
  { key: "spotlightTestimonial", label: "Community spotlight â€” testimonial / quote", kind: "single", rows: 3, polish: true },
  { key: "upcomingTitle",  label: "Upcoming events â€” section title",   kind: "header", ph: "Upcoming" },
  ...
  { key: "pastTitle",      label: "Past events â€” section title",       kind: "header", ph: "Past Events" },
  ...
  { key: "footerBrand",    label: "Footer â€” brand name",              kind: "header", ph: "SPROUT SOCIETY" },
  { key: "donateLink",     label: "Footer â€” Donate button (link)",    kind: "single", ph: "Button: URL, or [Button text](URL)" },
  { key: "memberLink",     label: "Footer â€” Become a member button (link)", kind: "single", ph: "Button: URL, or [Button text](URL)" },
];

/* â”€â”€â”€ Quick Hit (one-off): structured section model â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
   The one-off uses the SAME structured-section machinery as the compact roundup, so
   it gets the identical editor (text boxes, âœ¨ Polish, ðŸ–¼ image add, drag-crop, link
   parsing, live preview). Just fewer sections: heading, body, announcements, upcoming.
   buildQuickHit() renders HTML from these values. */
export const QUICK_HIT_SECTIONS = [
  { key: "headline",      label: "Heading",                  kind: "single", rows: 2, polish: true },
  { key: "body",          label: "Body",                     kind: "single", rows: 4, polish: true },
  { key: "announcements", label: "Announcements",            kind: "repeat", itemLabel: "announcement", itemImage: true, itemCrop: true, itemRatio: 544 / 200,
    fields: [{ k: "title", ph: "Announcement title" }, { k: "body", ph: "One or two lines", polish: true }, { k: "link", ph: "Button link (URL)" }, { k: "linkLabel", ph: "Button label (e.g. Learn more)" }] },
  { key: "upcoming",      label: "Upcoming event",           kind: "repeat", itemLabel: "event", itemImage: true, itemCrop: true, itemRatio: 544 / 180,
    fields: [{ k: "date", ph: "Date" }, { k: "name", ph: "Event name" }, { k: "note", ph: "Time Â· Location Â· one line", polish: true }, { k: "link", ph: "Button: URL, or [Button text](URL)" }] },
];
...
// Replace every literal occurrence of `find` (no regex â€” placeholders contain
...
const eventBlock = (e, i) => {
  ...
  const meta =
    [e.location, e.description].filter(Boolean).join(" Â· ") ||
    "[Time Â· Location Â· one-line description]";
...
/* â”€â”€â”€ Compact roundup renderer â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
// Empty values render as a muted [placeholder] so the live preview still reads.
const cph = (t) => `<span style="color:#c2c2bf;">[${t}]</span>`;
// Inline markdown links inside any fill-in box: `[label](https://url)` â†’ styled anchor.
// Runs AFTER esc() â€” the brackets/parens survive escaping (esc only touches & < >).
...
// Turn an already-escaped+linkified multiline string into HTML. Lines that start with
// "-", "*", or "•" become a bulleted <ul>/<li> list (email-safe, inline-styled); every
// other line keeps the <br> behavior. Bullets are opt-in by content, so plain copy is
// unaffected. Runs LAST (after esc + linkify), so list text can still contain links.
const richText = (html) => {
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    if (m) {
      if (!inList) { out += `<ul style="margin:8px 0; padding-left:22px;">`; inList = true; }
      out += `<li style="margin:0 0 4px 0; line-height:1.6;">${m[1]}</li>`;
    } else if (inList && line.trim() === "") {
      // A blank line between bullets keeps them in ONE list (common when people
      // separate bullets with an empty line) instead of starting a new <ul> each time.
      continue;
    } else {
      closeList();
...
// Real values: escape, linkify markdown, support bullet lists, and turn remaining
// newlines into <br> so pressing Enter in any fill-in box adds a line break in the
// email. Empty â†’ muted placeholder.
const cval = (v, t, linkColor) => (v && v.toString().trim() ? richText(linkify(esc(v), linkColor)) : cph(t));
// Editable static text (titles/subheaders/button labels): typed value, else the
// hardcoded default. Unlike cval, a blank field keeps the original wording â€” so
...
const compactUpcomingRows = (list) => {
  ...
  return items
    .map((e, i) => `                <tr data-sec-item="upcoming-${i}">\n${compactUpCard(e, i)}\n                </tr>`)
    .join("\n");
};

// Spotlight link button (Instagram / website), rendered inline. Empty field â†’ "".
...
// The two spotlight buttons laid out in a row below the blurb. All empty â†’ nothing.
  ...
  return items
    .map((e, i) => {
      ...
      const img = e.image
        ...
        : "";
      return `                <tr data-sec-item="past-${i}">
                  ...
                  <td style="padding:14px 0 14px 14px; font-family:'Lato',Helvetica,Arial,sans-serif;">
                    ...
                    <span style="font-size:13px; color:#8a8a86;">&nbsp;Â·&nbsp;${cval(e.date, "Date")}</span><br>
...
export function buildCompact({ fieldValues = {}, monthYear, profile = {}, today } = {}) {
  ...
  // Footer contact info â€” render as clickable links when the profile has a value, plain placeholder otherwise.
    ...
    <tr>
      <td align="center" style="padding:40px 12px;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%; max-width:600px; background-color:#FFFFFF; border-radius:8px; overflow:hidden;">
          ...
          <!-- MASTHEAD -->
          <tr>
            <td data-sec="masthead" style="padding:30px 18px 20px 18px; background-color:#FFFFFF;">
          ...
          <!-- INTRO / GREETING -->
          <tr>
            <td data-sec="intro" style="padding:24px 18px 0 18px; font-family:'Lato',Helvetica,Arial,sans-serif; font-size:22px; font-weight:900; line-height:1.3; color:#030000;">
              ${cval(v.headline, "A warm one-line headline")}
            </td>
          </tr>
          <tr>
            <td data-sec="intro" style="padding:10px 18px 2px 18px; font-family:'Lato',Helvetica,Arial,sans-serif; font-size:16px; line-height:1.6; color:#3a3a38;">
          ...
          <!-- FEATURED EVENT -->
          <tr>
            <td data-sec="featured" style="padding:24px 18px 6px 18px; font-family:'Lato',Helvetica,Arial,sans-serif; font-size:12px; font-weight:900; letter-spacing:2px; color:#E10098; text-transform:uppercase;">
              ${tval(v.featuredEyebrow, "Featured")} &middot; ${esc(monthLong.split(/\s+/)[0])}
            </td>
          </tr>
          <tr>
            <td data-sec="featured" style="padding:0 18px;">
          ...
          <tr>
            <td data-sec="featured" style="padding:16px 18px 4px 18px; font-family:'Lato',Helvetica,Arial,sans-serif; font-size:24px; font-weight:900; line-height:1.25; color:#030000;">
              ${cval(v.featuredTitle, "Featured event title")}
            </td>
          </tr>
          <tr>
            <td data-sec="featured" style="padding:0 18px 14px 18px; font-family:'Lato',Helvetica,Arial,sans-serif; font-size:16px; line-height:1.6; color:#3a3a38;">
          ...
          <!-- ANNOUNCEMENT -->
          <tr>
            <td data-sec="announce" style="padding:0 18px 24px 18px;">
          ...
          <!-- MEMBERSHIP -->
          <tr>
            <td data-sec="membership" style="padding:0 18px 24px 18px;">
          ...
          <!-- MARKETING -->
          <tr>
            <td data-sec="marketing" style="padding:0 18px 24px 18px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#73C4D6" style="border-radius:8px; overflow:hidden; box-shadow:0 4px 14px rgba(0,0,0,0.16);">
                <tr>
                  <td width="6" bgcolor="#FAD100" style="width:6px; line-height:1px; font-size:1px;">&nbsp;</td>
                  <td style="padding:22px 18px; font-family:'Lato',Helvetica,Arial,sans-serif;">
          ...
          <tr>
            <td data-sec="scholarship" style="padding:0 18px 24px 18px;">
          ...
          <!-- COMMUNITY SPOTLIGHT -->
          <tr>
            <td data-sec="spotlight" style="padding:0 18px 28px 18px;">
          ...
          <!-- EVENTS (scroll target â€” id on a real row so it isn't foster-parented out of the table) -->
          <tr id="events">
          ...
          <tr>
            <td data-sec="upcoming" style="padding:20px 18px 4px 18px; font-family:'Lato',Helvetica,Arial,sans-serif; font-size:13px; font-weight:900; letter-spacing:2px; color:#030000; text-transform:uppercase;">
              ${tval(v.upcomingTitle, "Upcoming")}
            </td>
          </tr>
          <tr>
            <td data-sec="upcoming" style="padding:0 18px 6px 18px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
${compactUpcomingRows(v.upcoming)}
          ...
          <tr>
            <td data-sec="past" style="padding:16px 18px 4px 18px; font-family:'Lato',Helvetica,Arial,sans-serif; font-size:13px; font-weight:900; letter-spacing:2px; color:#030000; text-transform:uppercase;">
              ${tval(v.pastTitle, "Past Events")}
            </td>
          </tr>
          <tr>
            <td data-sec="past" style="padding:0 18px 24px 18px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
${compactPastRows(v.past)}
          ...
          <!-- FOOTER -->
          <tr>
            <td data-sec="footer" style="padding:34px 20px; background-color:#FFFFFF; border-top:1px solid #ECECEA; font-family:'Lato',Helvetica,Arial,sans-serif;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td valign="top">
                    <p style="margin:0 0 6px 0; font-size:14px; font-weight:900; color:#030000; letter-spacing:1px;">${tval(v.footerBrand, "SPROUT SOCIETY")}</p>
                    <p style="margin:0 0 14px 0; font-size:13px; line-height:1.6; color:#6a6a66;">Brooklyn, NY &nbsp;Â·&nbsp; ${ig}</p>
                    ${(() => {
                    ...
                    <p style="margin:0; font-size:11px; line-height:1.6; color:#8a8a86;">
                      <unsubscribe><span style="color:#8a8a86; text-decoration:underline;">Unsubscribe</span></unsubscribe> &nbsp;Â·&nbsp; ${esc(profile.address || "Sprout Society, Brooklyn, NY")}${profile.ein ? `<br>Sprout Society is a registered 501(c)(3) nonprofit &nbsp;Â·&nbsp; EIN ${esc(profile.ein)}` : ""}
                    </p>
                  </td>
                  <td valign="middle" align="right" width="130" style="padding-left:16px;">
                    <img src="https://ixdnmjchvjzytyhmripc.supabase.co/storage/v1/object/public/newsletter-images/brand/sprout-logo-blackheart.png" alt="Sprout Society" width="120" style="display:block; border:0; height:auto; max-width:120px;">
                  </td>
                </tr>
              </table>
            </td>
...
/* â”€â”€â”€ Quick Hit (one-off) renderer â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
// One announcement block: cyan-barred box, optional photo on top, title, body, optional link button.
const qhAnnounceCard = (a, i) => {
  const img = (a.image || "").toString().trim()
    ? `<img src="${esc(a.image)}" alt="${esc(a.title || "Announcement")}" width="100%" height="200" style="display:block; width:100%; height:200px; object-fit:cover; object-position:${esc(a.imagePos || "center")}; border:0; border-radius:6px; margin:0 0 14px 0;">`
    : "";
  const btn = parseBtn(a.link, "Learn more");
  // Dedicated label field wins; falls back to a [text](url) markdown label, then "Learn more".
  const btnLabel = (a.linkLabel || "").toString().trim() || (btn ? btn.label : "Learn more");
  const btnHtml = btn
    ? `
                        <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin-top:14px;"><tr><td bgcolor="#030000" style="border-radius:4px;"><a href="${esc(btn.url)}" target="_blank" rel="noopener noreferrer" style="display:inline-block; padding:9px 18px; font-family:'Lato',Helvetica,Arial,sans-serif; font-size:13px; font-weight:900; color:#FAD100; text-decoration:none; white-space:nowrap;">${esc(btnLabel)} &rarr;</a></td></tr></table>`
    : "";
  return `              <tr data-sec-item="announcements-${i}">
                <td style="padding:0 18px 16px 18px;">
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#F7F7F6" style="border-radius:8px; overflow:hidden; box-shadow:0 4px 14px rgba(0,0,0,0.16);">
                    <tr>
                      <td width="6" bgcolor="#73C4D6" style="width:6px; line-height:1px; font-size:1px;">&nbsp;</td>
                      <td style="padding:20px 22px; font-family:'Lato',Helvetica,Arial,sans-serif;">
                        ${img}<span style="font-size:12px; font-weight:900; letter-spacing:2px; color:#73C4D6; text-transform:uppercase;">Announcement</span><br>
                        <span style="display:inline-block; padding-top:6px; font-size:20px; font-weight:900; color:#030000; line-height:1.3;">${cval(a.title, "Announcement title")}</span>
                        <p style="margin:8px 0 0 0; font-size:16px; line-height:1.6; color:#3a3a38;">${cval(a.body, "Share an update with the community.")}</p>${btnHtml}
                      </td>
                    </tr>
                  </table>
                </td>
...
// Announcements are optional — only render cards that actually have content, so an
// untouched blank in the editor never leaks placeholder text into the sent email.
const qhAnnounceRows = (list) => {
  const items = (list || []).filter((a) =>
    a && ["title", "body", "image", "link"].some((k) => (a[k] || "").toString().trim())
  );
  if (!items.length) return "";
  return items.map((a, i) => qhAnnounceCard(a, i)).join("\n");
};

/**
 * Render the one-off "Quick Hit" from structured section values.
 * Same masthead/footer as the compact roundup; body = heading + body + announcements + upcoming.
 */
export function buildQuickHit({ fieldValues = {}, monthYear, profile = {}, today } = {}) {
  const v = fieldValues || {};
  const monthLong = monthYear || defaultMonthYear(today) || "Month Year";
  return `<!DOCTYPE html>
<html lang="en">
...
<body style="margin:0; padding:0; background-color:#F7F7F6; font-family:'Lato','Helvetica Neue',Arial,sans-serif; color:#030000;">
  ...
  <div style="display:none; max-height:0; overflow:hidden; opacity:0; color:#F7F7F6; font-size:1px; line-height:1px;">${cval(v.body, "Inbox preview line")}</div>
    ...
    <tr>
      <td align="center" style="padding:40px 12px;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%; max-width:600px; background-color:#FFFFFF; border-radius:8px; overflow:hidden;">
          ...
          <!-- HEADING -->
          <tr>
            <td data-sec="headline" style="padding:24px 18px 0 18px; font-family:'Lato',Helvetica,Arial,sans-serif; font-size:22px; font-weight:900; line-height:1.3; color:#030000;">
              ${cval(v.headline, "A warm one-line heading")}
            </td>
          </tr>

          <!-- BODY -->
          <tr>
            <td data-sec="body" style="padding:10px 18px 22px 18px; font-family:'Lato',Helvetica,Arial,sans-serif; font-size:16px; line-height:1.6; color:#3a3a38;">
              ${cval(v.body, "A few sentences â€” recap, news, a thank-you.")}
            </td>
          </tr>

          <!-- ANNOUNCEMENTS -->
${qhAnnounceRows(v.announcements)}

          <!-- UPCOMING -->
          <tr>
            <td data-sec="upcoming" style="padding:6px 18px 4px 18px; font-family:'Lato',Helvetica,Arial,sans-serif; font-size:12px; font-weight:900; letter-spacing:2px; color:#E10098; text-transform:uppercase;">
              Next up
            </td>
          </tr>
          <tr>
...
${compactUpcomingRows(v.upcoming)}
          ...
          <!-- FOOTER -->
          <tr>
            <td style="padding:34px 20px; background-color:#FFFFFF; border-top:1px solid #ECECEA; font-family:'Lato',Helvetica,Arial,sans-serif;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td valign="top">
                    <p style="margin:0 0 6px 0; font-size:14px; font-weight:900; color:#030000; letter-spacing:1px;">SPROUT SOCIETY</p>
                    <p style="margin:0 0 14px 0; font-size:13px; line-height:1.6; color:#6a6a66;">Brooklyn, NY &nbsp;Â·&nbsp; <a href="https://instagram.com/sproutsocietyorg" target="_blank" rel="noopener noreferrer" style="color:#6a6a66; text-decoration:underline;">@sproutsocietyorg</a></p>
                    ...
                    <p style="margin:0; font-size:11px; line-height:1.6; color:#8a8a86;">
                      <unsubscribe><span style="color:#8a8a86; text-decoration:underline;">Unsubscribe</span></unsubscribe> &nbsp;Â·&nbsp; ${esc(profile.address || "26 Scott Ave, Brooklyn, NY 11237")}${profile.ein ? `<br>Sprout Society is a registered 501(c)(3) nonprofit &nbsp;Â·&nbsp; EIN ${esc(profile.ein)}` : "<br>Sprout Society is a registered 501(c)(3) nonprofit &nbsp;Â·&nbsp; EIN 83-1298420"}
                    </p>
                  </td>
                  <td valign="middle" align="right" width="130" style="padding-left:16px;">
                    <img src="https://ixdnmjchvjzytyhmripc.supabase.co/storage/v1/object/public/newsletter-images/brand/sprout-logo-blackheart.png" alt="Sprout Society" width="120" style="display:block; border:0; height:auto; max-width:120px;">
...
/**
 * Render a newsletter.
 *   templateId    â€” "monthly-roundup" | "quick-hit"
 *   monthYear     â€” e.g. "June 2026" (falls back to today's month)
 *   events        â€” CRM events (used for recap + upcoming blocks on the roundup)
 *   profile       â€” org profile (website + IG fill the footer)
 *   fieldValues   â€” { [placeholderKey]: string } the user typed
 *   spotlightName â€” optional name to drop into the spotlight block
 *   recapLimit / upcomingLimit â€” caps on auto-filled blocks
 *   today         â€” "YYYY-MM-DD" (passed in so the engine stays pure/testable)
 *
...
export function buildNewsletter({
  ...
  // Quick Hit (one-off) also uses structured sections now (same editor as the compact roundup).
  if (templateId === "quick-hit") {
    return {
      html: buildQuickHit({ fieldValues, monthYear: monthYear || defaultMonthYear(today), profile, today }),
      placeholders: [],
      recapsUsed: [],
      upcomingUsed: [],
    };
  ...
  if (spotlightName) {
    html = html
      .replace(/\[NAME â€” e\.g\. Pat\]/g, esc(spotlightName))
      .replace(/\[NAME\]/g, esc(spotlightName));
    // No photo on file â†’ drop the optional photo cell so there's no broken img.
...
/* â”€â”€â”€ Raw Templates â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */
// 600px, table-based, inline-styled. Mirror docs/newsletter/*.html. Keep the
// <!-- RECAP BLOCK ... /RECAP BLOCK --> and <!-- EVENT BLOCK ... /EVENT BLOCK -->
// markers intact â€” buildNewsletter swaps them for CRM-derived content.
...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Sprout Society â€” [MONTH] Roundup</title>
</head>
<body style="margin:0; padding:0; background-color:#F7F7F6; font-family:'Lato','Helvetica Neue',Arial,sans-serif; color:#030000;">

  <div style="display:none; max-height:0; overflow:hidden; opacity:0;">
    [ONE-LINE PREVIEW â€” e.g. "Thanks for a great month + here's what's coming up at Sprout."]
  </div>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:14px;">
                <tr>
                  ...
                  <td valign="top">
                    ...
                    <p style="margin:0; font-size:13px; line-height:1.5; color:#4B5563;">[Time Â· Location Â· one-line description]</p>
                  </td>
                </tr>
              </table>
              <!-- /EVENT BLOCK -->
                  ...
                  <td style="padding:24px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td valign="top">
                          <p style="margin:0 0 2px 0; font-size:18px; font-weight:900; color:#030000;">[NAME â€” e.g. Pat]</p>
          ...
          <tr>
            <td style="background-color:#030000; padding:28px 32px; border-radius:0 0 14px 14px;">
              ...
              <p style="margin:0 0 14px 0; font-size:12px; line-height:1.6; color:#9CA3AF;">
                Brooklyn, NY Â· [WEBSITE] Â· [INSTAGRAM @handle]
              </p>
              <p style="margin:0; font-size:11px; line-height:1.5; color:#6b7280;">
                ...
                <a href="*|UNSUB|*" style="color:#73C4D6; text-decoration:underline;">Unsubscribe</a> &nbsp;Â·&nbsp; *|LIST:ADDRESS|*
              </p>
            </td>
          </tr>
