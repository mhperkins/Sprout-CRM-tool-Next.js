...
export const COMPACT_SECTIONS = [
  ...
  { key: "seeMoreLabel",   label: "Featured — \"see more events\" button", kind: "header", ph: "See more events" },
  { key: "seeMoreLink",    label: "Featured — \"see more events\" button link (blank = scroll to Upcoming)", kind: "header", ph: "Blank = scroll to Upcoming events" },
    ...
    <tr>
      <td align="center" style="padding:40px 12px;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%; max-width:600px; background-color:#FFFFFF; border-radius:8px; overflow:hidden;">
          ...
          ${(() => {
            // Default: scroll down to the Upcoming events section (#events) within the newsletter.
            // If a seeMoreLink is explicitly filled in, link out to that URL instead (opens in a new tab).
            const link = (v.seeMoreLink || "").trim();
            const href = link ? esc(link) : "#events";
            const ext = link ? ' target="_blank" rel="noopener noreferrer"' : "";
            return `<tr>
            <td style="padding:0 28px 24px 28px;">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr><td bgcolor="#030000" style="border-radius:4px;">
                  <a href="${href}"${ext} style="display:inline-block; padding:11px 22px; font-family:'Lato',Helvetica,Arial,sans-serif; font-size:13px; font-weight:900; color:#FAD100; text-decoration:none;">${tval(v.seeMoreLabel, "See more events")} &rarr;</a>
                </td></tr>
              </table>
            </td>
          </tr>`;
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#F7F7F6" style="border-radius:8px; box-shadow:0 4px 14px rgba(0,0,0,0.16);">
                <tr>
                  ...
                  <td style="padding:20px 22px; font-family:'Lato',Helvetica,Arial,sans-serif;">
                    ...
                    <p style="margin:8px 0 0 0; font-size:15px; line-height:1.6; color:#3a3a38;">${cval(v.coworking, "Share an update with the community. What's new, what's changing, what to know.")}</p>
                    ${
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                      ...
                      <tr>
                        <td style="padding-top:14px;">
                          <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                            <tr><td bgcolor="#030000" style="border-radius:4px;">
                              <a href="https://givebutter.com/sproutmembership" target="_blank" rel="noopener noreferrer" style="display:inline-block; padding:9px 18px; font-family:'Lato',Helvetica,Arial,sans-serif; font-size:13px; font-weight:900; color:#FAD100; text-decoration:none; white-space:nowrap;">${tval(v.membershipBtn, "Become a member")} &rarr;</a>
                            </td></tr>
                          </table>
                        </td>
                      </tr>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #ECECEA; border-radius:8px; box-shadow:0 4px 14px rgba(0,0,0,0.16);">
                <tr>
                  ...
                  <td style="padding:22px 22px; font-family:'Lato',Helvetica,Arial,sans-serif;">
                    ...
                    <span style="display:inline-block; margin-top:4px; font-size:14px; line-height:1.6; color:#3a3a38;">${cval(v.spotlightBlurb, "Two or three line spotlight blurb.")}</span>
                    ${
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td valign="top">
                    ...
                    ${(() => { const b = parseBtn(v.donateLink, "Donate"); return b ? `<table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 16px 0;"><tr><td style="border-radius:6px; background-color:#E10098;"><a href="${esc(b.url)}" target="_blank" rel="noopener noreferrer" style="display:inline-block; padding:10px 22px; font-family:'Lato',Helvetica,Arial,sans-serif; font-size:13px; font-weight:900; letter-spacing:0.5px; color:#ffffff; text-decoration:none; border-radius:6px;">${esc(b.label)} &rarr;</a></td></tr></table>` : ""; })()}
