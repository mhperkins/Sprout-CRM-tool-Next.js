...
export const COMPACT_SECTIONS = [
  ...
  { key: "seeMoreLink",    label: "Featured — \"see more events\" button link", kind: "header", ph: "https://luma.com/sproutsociety" },
            ...
            <td style="padding:0 28px 24px 28px;">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr><td bgcolor="#030000" style="border-radius:4px;">
                  <a href="${esc(tval(v.seeMoreLink, "https://luma.com/sproutsociety"))}" target="_blank" rel="noopener noreferrer" style="display:inline-block; padding:11px 22px; font-family:'Lato',Helvetica,Arial,sans-serif; font-size:13px; font-weight:900; color:#FAD100; text-decoration:none;">${tval(v.seeMoreLabel, "See more events")} &rarr;</a>
                </td></tr>
              </table>
            </td>
          </tr>
