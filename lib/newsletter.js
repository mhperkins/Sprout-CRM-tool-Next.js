...
const cval = (v, t) => (v && v.toString().trim() ? linkify(esc(v)) : cph(t));
    ...
    <tr>
      <td align="center" style="padding:40px 12px;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%; max-width:600px; background-color:#FFFFFF; border-radius:8px; overflow:hidden;">
          ...
          <tr>
            <td style="padding:0 28px 24px 28px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#C6C902" style="border-radius:8px;">
                <tr>
                  <td style="padding:24px 24px; font-family:'Lato',Helvetica,Arial,sans-serif;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td valign="middle" style="font-family:'Lato',Helvetica,Arial,sans-serif; font-size:17px; font-weight:700; color:#FFFFFF; line-height:1.45; padding-right:20px;">${
                          v.marketing && v.marketing.toString().trim()
                            ? linkify(esc(v.marketing)).replace(/\n/g, "<br>")
                            : `<span style="color:#FFFFFF; opacity:0.6;">[One-line marketing message.]</span>`
                        }</td>
                        <td valign="middle" align="right">
                          <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                            <tr><td bgcolor="#030000" style="border-radius:4px;">
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #ECECEA; border-radius:8px;">
                <tr>
                  ...
                  <td style="padding:22px 22px; font-family:'Lato',Helvetica,Arial,sans-serif;">
                    <span style="font-size:12px; font-weight:900; letter-spacing:2px; color:#8a9000; text-transform:uppercase;">Community Sprout Shout</span><br>
                    ${
