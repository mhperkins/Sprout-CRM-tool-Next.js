    ...
    <tr>
      <td align="center" style="padding:40px 12px;">
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="width:100%; max-width:600px; background-color:#FFFFFF; border-radius:8px; overflow:hidden;">
            ...
            <td style="padding:30px 18px 20px 18px; background-color:#FFFFFF;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  ...
                  <td align="right" valign="middle" style="font-family:'Lato',Helvetica,Arial,sans-serif; font-size:11px; font-weight:700; letter-spacing:2px; color:#030000; text-transform:uppercase;">
                    Sprout Society<br>
                    <span style="color:#8a8a86;">[MONTH YEAR]</span>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <!-- HEADLINE + RECAP -->
          <tr>
            <td data-sec="qh-headline" style="padding:24px 18px 0 18px; font-family:'Lato',Helvetica,Arial,sans-serif; font-size:22px; font-weight:900; line-height:1.3; color:#030000;">
              [HEADLINE — e.g. "Game night was a blast - here's what's next"]
            </td>
          </tr>
          <tr>
            <td data-sec="qh-recap" style="padding:10px 18px 22px 18px; font-family:'Lato',Helvetica,Arial,sans-serif; font-size:16px; line-height:1.6; color:#3a3a38;">
          ...
          <!-- NEXT EVENT -->
          <tr>
            <td data-sec="qh-nextup" style="padding:0 18px 24px 18px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#F7F7F6" style="border-radius:8px; overflow:hidden; box-shadow:0 4px 14px rgba(0,0,0,0.16);">
                <tr>
                  <td width="6" bgcolor="#73C4D6" style="width:6px; line-height:1px; font-size:1px;">&nbsp;</td>
                  <td style="padding:20px 22px; font-family:'Lato',Helvetica,Arial,sans-serif;">
                    <span style="font-size:12px; font-weight:900; letter-spacing:2px; color:#E10098; text-transform:uppercase;">Next up</span><br>
                    <span style="display:inline-block; padding-top:6px; font-size:20px; font-weight:900; color:#030000; line-height:1.3;">[EVENT NAME]</span>
                    <p style="margin:8px 0 0 0; font-size:16px; line-height:1.6; color:#3a3a38;">[Date · Time · Location · one line]</p>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <!-- CTA -->
          <tr>
            <td data-sec="qh-cta" style="padding:0 18px 30px 18px;">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td bgcolor="#E10098" style="border-radius:6px;">
                    <a href="[RSVP LINK / SCHOLARSHIP LINK]" target="_blank" rel="noopener noreferrer" style="display:inline-block; padding:13px 28px; font-family:'Lato',Helvetica,Arial,sans-serif; font-size:15px; font-weight:900; color:#FFFFFF; text-decoration:none;">[RSVP &rarr; / Apply for a scholarship &rarr;]</a>
                  </td>
                </tr>
              </table>
            </td>
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td valign="top">
                    ...
                    <p style="margin:0; font-size:11px; line-height:1.6; color:#8a8a86;">
                      <unsubscribe><span style="color:#8a8a86; text-decoration:underline;">Unsubscribe</span></unsubscribe> &nbsp;·&nbsp; 26 Scott Ave, Brooklyn, NY 11237<br>Sprout Society is a registered 501(c)(3) nonprofit &nbsp;·&nbsp; EIN 83-1298420
                    </p>
                  </td>
                  <td valign="middle" align="right" width="130" style="padding-left:16px;">
                    <img src="https://ixdnmjchvjzytyhmripc.supabase.co/storage/v1/object/public/newsletter-images/brand/sprout-logo-blackheart.png" alt="Sprout Society" width="120" style="display:block; border:0; height:auto; max-width:120px;">
