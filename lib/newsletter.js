...
export const COMPACT_SECTIONS = [
  ...
  { key: "upcoming",       label: "Upcoming events",                  kind: "repeat", itemLabel: "event", itemImage: true, itemCrop: true, itemRatio: 234 / 140,
...
const compactUpCard = (e, side) => {
  ...
  const img = e.image
    ? `<img src="${esc(e.image)}" alt="${esc(e.name || "Event")}" width="100%" height="140" style="display:block; width:100%; height:140px; object-fit:cover; object-position:${esc(e.imagePos || "center")}; border:0; border-radius:6px; margin-bottom:10px;">`
    : "";
            ...
            <td style="padding:0 28px 24px 28px;">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr><td bgcolor="#030000" style="border-radius:4px;">
                  <a href="#events" style="display:inline-block; padding:11px 22px; font-family:'Lato',Helvetica,Arial,sans-serif; font-size:13px; font-weight:900; color:#FAD100; text-decoration:none;">${tval(v.seeMoreLabel, "See more events")} &darr;</a>
                </td></tr>
              </table>
            </td>
          </tr>
